...
// JDBC driver name and database URL
    ...
    /**
     * Method to handling the connection to the database, dependent on user's
     * input.
     *
    ...
    /**
     * Prepares and executes a Book Insert SQL Statement
     * @param conn The connection to the database
     * @param stmt The SQL statement for a book insert
     */
    ...
    /**
     * Prepares and executes a Book Remove SQL Statement
     * @param conn The connection to the database
     * @param stmt The SQL statement for a book remove
     */
    ...
    /**
     * Method to handle the insertion and following replacement of a current
     * publisher in its books.
     *
    ...
    /**
     * Method to replace a publisher and all books associated with that
     * publisher
     *
     * @param conn the connection to the database
    ...
    public static void replacePublishers(Connection conn, String pubName) {
        ...
        if(oldPub.equals("")) {
            System.out.println("No replacement done.");
        } else {
            try {
